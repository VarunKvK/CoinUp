  ...
  return (
    <div className="bg-black p-6 rounded-lg row-span-2">
      ...
      <div className="mt-2 grid grid-auto gap-2 max-h-48 overflow-y-auto rounded scrollbar-thin">
        ...
        <li className="list-none mb-2 text-white text-sm p-1 border-b border-gray-200 last:border-b-0">To get the 'Balance' after updating your income just refresh the page.</li>
        <li className="list-none mb-2 text-white text-sm p-1 border-b border-gray-200 last:border-b-0">Detailed Budget Expenses are available by hovering on the 'Monthly Budget Expenses Graph'.</li>
      </div>
    </div>
  );
}
